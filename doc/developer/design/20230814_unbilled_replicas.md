...
We allow internal users to create replica sets with specific billing information to add free or cost-reduced resouces to user environments, without changing the structure of a user's deployment.
